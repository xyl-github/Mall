...
<div class="container" id="app" style="margin-top: 2%">
    ...
    <table class="table table-bordered table-hover tab-content text-center">
        ...
        <tr v-for="floor in floorList">
            ...
            <td><img v-bind:src="floor.imageUrl" @click="show(floor.imageUrl)" style="width: 60px;"/></td>
                    ...
                    <form class="bs-example bs-example-form" id="addForm" role="form" enctype="multipart/form-data">
                        ...
                        <div class="input-group col-md-4" style="margin-top: 15px;">
                            ...
                            <select class="form-control" v-model="addFloor.doBusinessSiteId">
                                <option v-for="shopPlace in shopPlaceList" v-bind:value="shopPlace.id">
                                    {{shopPlace.name}}
                                </option>
                            </select>
                        </div>
                        ...
                        <div class="input-group col-md-9" style="margin-top: 15px;">
                            ...
                            <input type="text" class="form-control" value="1" v-model="addnum"
                ...
                <div class="modal-body">
                    <form class="bs-example bs-example-form" id="updateForm" role="form" enctype="multipart/form-data">
                        ...
                        <div class="input-group col-md-9" style="margin-top: 15px;">
                            ...
                            <input type="text" class="form-control" v-model="updatenum" style="text-align: center"/>
                            <span class="input-group-btn">
                                <button class="btn" type="button" style="color: #6c757d;background-color: #f9f2f4;"
    ...
    var v = new Vue({
        ...
        methods: {
            ...
            update(floor) {
                ...
                axios
                    .post('/floorAdmin/findById?id=' + floor.id)
                    .then(function (response) {
                        console.log(response);
                        that.updateFloor = response.data.responseResult;
                    })
                    .catch(function (error) {
                        console.log(error);
                    });
                that.updatenum = that.updateFloor.floor;
                oldImage = that.updateFloor.imageUrl;
            ...
            updateFloorOne: function () {
                ...
                params.append('imageUrl', updateUrl);
